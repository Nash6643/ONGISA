...
export default function DependencyGraph() {
  const [data, setData] = useState<{ files: FileData[]; stats: any } | null>(null);
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 p-6">
      <div className="col-span-2 bg-gray-900 border border-gray-800 rounded-xl p-4">
        <h2 className="text-xl font-semibold mb-4 text-cyan-400">Project Modules ({data.files.length})</h2>
          ...
          {data.files.map((file) => (
            ...
            >
              <div className="flex justify-between items-center">
                ...
                <span className="text-xs text-gray-500">{(file.size_bytes / 1024).toFixed(1)} KB</span>
              </div>
